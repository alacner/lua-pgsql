...
print("===========================")
print("===========================")
local res,b,c = db:execute("my_query", "2")
print_r(res:fetch_all_columns())
print_r(b)
print_r(c)
print("===========================")
print("===========================")
local res,b,c = db:execute("my_query")
print_r(res)
print_r(b)
print_r(c)
print("===========================")
local res = db:query_params("SELECT * FROM tbl WHERE id <> $1", 2)
print_r(res:fetch_all_columns())
print_r(b)
print_r(c)
print("===========================")
